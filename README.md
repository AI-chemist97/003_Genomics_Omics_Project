...
![PCA Plot](figure\pca_of_tumor_and_normal_sample.png)
...
![1차 혼돈 행렬 이미지](figure/1st_confusion_matrix.png)
...
![2차 혼돈 행렬 이미지](figure/2nd_confusion_matrix.png)
...
![특성 중요도 그래프](figure/Top20_importance_features.png)

- **결론:** `228507_at`, `209950_s_at`, `235651_at` 등이 췌장암을 구분하는 가장 핵심적인 생물학적 마커일 가능성이 높다는 구체적인 결론을 **도출**했습니다. 하지만 class_weight와 같은 부분에서 별다른 고민이나 서치 없이 임의로 가중치를 10 부여한 것과 샘플의 수가 적은 부분을 개선하여 2차로 진행 예정.
</details>
